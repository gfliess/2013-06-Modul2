 ...
 *
 * $Id: GapList.java 1538 2013-02-21 22:59:44Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: GapList.java 1538 2013-02-21 22:59:44Z origo $
 *
...
public class GapList<E> extends AbstractList<E>
	 ...
	 */
	@SuppressWarnings("unchecked")
	void init(Object[] newValues, boolean empty) {
		if (newValues != null) {
			values = (E[]) newValues;
		}
	 ...
	 * This is the only method which really add an element.
